...
class IntroScreen extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    ...
    PageViewModel(
      ...
      body: 'ระบบนี้จะช่วยให้คุณจองล่วงหน้าทำให้ไม่มีใครต้องเสียเวลารอคิวหลายนาทีเพื่อแค่พบหมอเพื่อแค่ดูอาการสัตว์เลี้ยง',
      footer: Column(
        children: [
          SizedBox(
            height: 45,
    ...
    PageViewModel(
      ...
      body: 'สำหรับใครที่มีสัตว์เลี้ยงหลายตัวสามารถทำเป็นหน้ารวมสัตว์เลี้ยงของคุณได้',
      footer: Column(
        children: [
          SizedBox(
            height: 45,
